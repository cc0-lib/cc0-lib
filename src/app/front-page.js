    ...
    <>
      ...
      <div className=" fixed bottom-0 left-0 z-10 mb-60 flex flex-col">
        <input
          ...
          autoComplete="off"
          autoCorrect="off"
          className="duration-250 focus:ring-none peer peer pointer-events-auto mx-4 h-20 w-full bg-transparent px-6 font-rubik text-4xl text-white drop-shadow-md transition-all ease-linear selection:bg-zinc-800 selection:text-sec placeholder:text-zinc-600 focus:rounded-sm focus:bg-zinc-800 focus:bg-opacity-50 focus:outline-none focus:backdrop-blur-md sm:mx-20 sm:h-40 sm:max-w-xl sm:text-8xl"
