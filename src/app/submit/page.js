...
const SubmissionPage = () => {
  return (
    <main
      className=" flex min-h-screen flex-col items-center justify-between overflow-y-scroll bg-white p-12 font-spline
        text-black selection:bg-zinc-800 selection:text-prim dark:bg-[#191919] dark:text-white"
    >
      ...
      <iframe
        className="inset-0 left-0 top-0 h-[70vh] w-full border-0 bg-white pt-16 dark:bg-[#191919]"
